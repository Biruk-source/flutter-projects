...
class _ProfessionalHubScreenState extends State<ProfessionalHubScreen>
      ...
      if (!serviceEnabled) {
        if (mounted)
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content:
                  Text(appStrings.professionalSetupErrorLocationDisabled)));
        return;
      }
      ...
      if (permission == LocationPermission.denied) {
        ...
        if (permission == LocationPermission.denied) {
          if (mounted)
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content:
                    Text(appStrings.professionalSetupErrorLocationDenied)));
          return;
        }
      }
      ...
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(appStrings
                .professionalSetupErrorGettingLocation(e.toString()))));
    } finally {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content:
                  Text(appStrings.professionalSetupErrorLoading(e.toString())),
              backgroundColor: Colors.red));
        }
      } finally {
        if (mounted) {
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      messenger.showSnackBar(SnackBar(
          content: Text(appStrings.professionalSetupInfoUploadingMedia)));
  ...
  Future<void> _pickMultiImage(List<dynamic> targetList) async {
    ...
    if (targetList.length >= 6) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(appStrings.professionalSetupErrorMaxImages)));
      }
      return;
    }
    final pickedFiles =
            ...
            child: Column(
              children: [
                Padding(
                    ...
                    child: Text(appStrings.professionalSetupSkillsDialogTitle,
                        style: theme.textTheme.titleLarge)),
                Text(appStrings.professionalSetupSkillsDialogSubtitle,
                    ...
                    children: [
                      Expanded(
                          child: OutlinedButton(
                              ...
                              child: Text(appStrings
                                  .professionalSetupSkillsDialogCancel))),
                      ...
                      Expanded(
                          child: ElevatedButton(
                              ...
                              child: Text(appStrings
                                  .professionalSetupSkillsDialogConfirm))),
                    ],
                  ),
                ),
              ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // The save button is now a FloatingActionButton, so it's always visible
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: AnimatedOpacity(
                ...
                duration: 200.ms,
                child: Text(appStrings.professionalSetupTitle,
                    style: theme.textTheme.titleLarge),
              ),
              background: ClipRect(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            Text(appStrings.professionalSetupNavHeader,
                                style: theme.textTheme.headlineSmall),
                            Text(appStrings.professionalSetupSubtitle,
  ...
  // NEW: Changed to FloatingActionButton.extended
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        // FIX: The actions are now part of the main state's _buildAppBarActions
        // This widget is for desktop only, so we can access the state actions differently
        // or just have the save button. For simplicity, let's just have the save button.
        ElevatedButton.icon(
          onPressed: onSave,
          icon: isSaving
              ? const SizedBox(
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
            ...
            child: Text(appStrings.professionalSetupNavHeader,
                style: theme.textTheme.titleLarge)),
...
class _SkillSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(appStrings.professionalSetupSkillsSelectedTitle,
          style: theme.textTheme.titleMedium),
      const SizedBox(height: 12),
      Container(
          ...
          child: selectedSkills.isEmpty
              ? Center(
                  child: TextButton.icon(
                      ...
                      label:
                          Text(appStrings.professionalSetupSkillsEmptyButton)))
              : Wrap(
                  spacing: 8,
                  runSpacing: 8,
                  children: [
                    ...
                    ActionChip(
                        label:
                            Text(appStrings.professionalSetupSkillsEditButton),
...
class _LocationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      const SizedBox(height: 24),
      Text(appStrings.professionalSetupServiceRadiusTitle,
          style: theme.textTheme.titleMedium),
      const SizedBox(height: 8),
      Text(appStrings.professionalSetupServiceRadiusSubtitle,
          style: theme.textTheme.bodyMedium
              ?.copyWith(color: theme.colorScheme.onSurfaceVariant)),
      const SizedBox(height: 16),
      Row(children: [
            ...
            child: Center(
              child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(appStrings.professionalSetupVideoEmptyButton,
                    ...
                    child: Center(
                        child: Column(
                          ...
                          Icon(Icons.add_photo_alternate_outlined,
                              color: Theme.of(context).colorScheme.primary),
                          const SizedBox(height: 4),
                          Text(appStrings.professionalSetupImageEmptyButton,
