...
class _ProfessionalSetupScreenState extends State<ProfessionalSetupScreen> {
  ...
  void initState() {
    ...
    // NEW: Automatically fetch location on init
  ...
  // NEW: Function to get location and update the text field
  ...
  void _nextPage() {
    ...
    // Allow moving to the last page even if fields are empty
    if (_currentPage < 4) {
      // We have 5 pages now
  ...
  // MODIFIED: This function now correctly calls the updated saveWorker service.
  Future<void> _saveProfileAndFinish() async {
    if (!_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Please fill out all required fields before finishing.'),
        backgroundColor: Colors.red,
      ));
      return;
    }
    ...
    try {
      messenger.showSnackBar(const SnackBar(
          content: Text('Uploading media, this may take a moment...')));
      ...
      messenger.showSnackBar(
          const SnackBar(content: Text('Finalizing your profile...')));
      ...
      await _firebaseService.saveWorker(
        ...
        serviceRadius: 20.0, // Default service radius for new users
      );
  ...
  Future<List<String>> _uploadFileList(
      List<XFile> fileList, String folder) async {
    final urls = <String>[];
  ...
  Future<void> _pickMultiImage(List<XFile> targetList) async {
  ...
  Widget build(BuildContext context) {
    ...
    final pages = [
      ...
      _buildExpertisePage(theme),
      _buildShowcasePage(theme),
      _buildOperationsPage(theme), // Added new page
    ];
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          // MODIFIED: No "Skip" button. The user must complete the setup.
        ),
        body: Form(
          key: _formKey,
          child: Column(
  ...
  Widget _buildBottomBar(ThemeData theme) {
    final isLastPage = _currentPage == 4; // Now 5 pages, so index 4 is last
    return Container(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text("${(_profileStrength * 100).toInt()}%",
          ...
          LinearPercentIndicator(
            ...
            progressColor: Color.lerp(Colors.orange.shade300,
                theme.colorScheme.primary, _profileStrength)!,
            animation: true,
          ),
  ...
  // MODIFIED: Beautified Welcome Page
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(Icons.shield_moon_rounded,
                ...
                .animate() // chain an animation
                .fadeIn(duration: 1200.ms, curve: Curves.easeOut)
                .scale(duration: 1200.ms),
            const SizedBox(height: 32),
            Text("Let's Build Your Professional Profile!",
                ...
                .slideY(begin: 0.2),
            const SizedBox(height: 16),
            Text("A complete, trustworthy profile helps you stand out and win more jobs. Let's start with a friendly photo.",
  ...
  Widget _buildBasicInfoPage(ThemeData theme) {
    return ListView(
      ...
      children: <Widget>[
        _buildSectionHeader(
            theme, "About You", "This is how clients will identify you."),
        _CustomTextField(
  ...
  Widget _buildExpertisePage(ThemeData theme) {
    return ListView(
      padding: const EdgeInsets.all(24),
      children: <Widget>[
        _buildSectionHeader(
            theme, "Your Expertise", "Showcase your experience and skills."),
        _CustomTextField(
  ...
  Widget _buildShowcasePage(ThemeData theme) {
    return ListView(
      padding: const EdgeInsets.all(24),
      children: <Widget>[
        _buildSectionHeader(theme, "Media Showcase",
  ...
  // NEW: Added a page for pricing and availability
  Widget _buildOperationsPage(ThemeData theme) {
    return ListView(
      padding: const EdgeInsets.all(24),
      children: <Widget>[
        _buildSectionHeader(
            theme, "Business Details", "Set your rates and working hours."),
        const SizedBox(height: 16),
        _TitledContent(
...
class _CustomTextField extends StatelessWidget {
  ...
  final String? hint;
  final IconData? icon;
  final Widget? suffixIcon; // MODIFIED: Added suffixIcon
  ...
  const _CustomTextField(
      ...
      this.hint,
      this.icon,
      this.suffixIcon, // MODIFIED: Added to constructor
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: suffixIcon, // MODIFIED: Used here
...
// NEW: Added Day Availability Grid widget
